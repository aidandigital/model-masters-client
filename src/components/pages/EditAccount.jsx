    ...
    return (
      ...
      {(currentUser) => (
        ...
        <Section>
            ...
            <TagInput name="types" customStateSetter={this.setTagInput} value={this.state.types} allowedTags={["Cars", "Tanks", "Trains", "Ships", "Trucks"]} error={this.state.message.types} description="What kinds of models like?" />
